...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "Interactive application using the Rick and Morty API that allows users to explore characters, episodes and locations from the series, with the option to filter and search for detailed information about each one.",
  ...
  },
  {
    ...
    title: "Movies app",
    description:
      "This project is a movie application connected to TheMovieDB API, which allows users to explore and discover popular movies, view details such as synopsis and ratings.",
    stack: [{ name: "Html 5" }, { name: "CSS" }, { name: "CSS" }],
  ...
  },
  {
    ...
    description:
      "This project is an interactive dashboard designed to present information coming from multiple APIs or static JSON, in a clear and visual manner. It uses dynamic graphs to facilitate the interpretation of data.",
    stack: [
      { name: "Html 5" },
      { name: "ReactJS" },
      { name: "JavaScript" },
    ...
    image: "/assets/Projects/pantalla-analiticas.png",
    live: "https://oralia31.github.io/analytical-dashboard/",
    github: "https://github.com/Oralia31/analytical-dashboard",
  },
  {
    num: "07",
    category: "Frontend",
    ...
    title: "Calculator",
    description:
      "Web calculator that performs basic operations such as addition, subtraction, multiplication and division, with an intuitive and easy-to-use interface, ideal for quick and simple calculations.",
